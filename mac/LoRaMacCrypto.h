 ...
 * devices \remark Only applies to LoRaWAN 1.0.x when following recomendations
 ...
 * used. \param[IN]     keyID           - Key identifier of the root key to use
 * to perform the derivation ( AppKey ) \retval                        - Status
 * of the operation
 */
 ...
 *
 * \param[IN]     keyID           - Key identifier of the root key to use to
 * perform the derivation ( McRootKey ) \retval                        - Status
 * of the operation
 */
