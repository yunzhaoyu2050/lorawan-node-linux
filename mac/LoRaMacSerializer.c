...
LoRaMacSerializerJoinRequest(LoRaMacMessageJoinRequest_t *macMsg) {
  ...
  memcpyr(&macMsg->Buffer[bufItr], macMsg->JoinEUI,
...
LoRaMacSerializerStatus_t LoRaMacSerializerData(LoRaMacMessageData_t *macMsg) {
  ...
  // Check macMsg->BufSize
  uint16_t computedBufSize =
      LORAMAC_MHDR_FIELD_SIZE + LORAMAC_FHDR_DEV_ADDR_FIELD_SIZE +
  ...
  memcpy1(&macMsg->Buffer[bufItr], macMsg->FHDR.FOpts,
