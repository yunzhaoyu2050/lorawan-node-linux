 ...
 * Pointer to the Write/Read functions.
 */
 ...
 *
 * \param [IN] fragNb     Number of expected fragments (without redundancy
 * packets) \param [IN] fragSize   Size of a fragment \param [IN] file Pointer
 * to file buffer size \param [IN] fileSize   File buffer size
 */
