...
void DisplayNetworkParametersUpdate(
...
void DisplayBeaconUpdate(LoRaMacHandlerBeaconParams_t *params) {
  ...
  case LORAMAC_HANDLER_BEACON_RX: {
    printf("\n###### ===== BEACON %8u ==== ######\n",
           (unsigned int)params->Info.Time.Seconds);
