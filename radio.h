...
struct Radio_s {
   ...
   * timeout in number of bytes LoRa: timeout in symbols \param [IN] fixLen
   * Fixed length packets [0: variable, 1: fixed] \param [IN] payloadLen   Sets
   * payload length when fixed length is used \param [IN] crcOn Enables/Disables
   ...
   * hopping FSK : N/A ( set to 0 ) LoRa: [0: OFF, 1: ON] \param [IN] hopPeriod
   * Number of symbols between each hop FSK : N/A ( set to 0 ) LoRa: Number of
   * symbols \param [IN] iqInverted   Inverts IQ signals (LoRa only) FSK : N/A (
   * set to 0 ) LoRa: [0: not inverted, 1: inverted] \param [IN] timeout
   ...
   *                          LoRa: Length in symbols (the hardware adds 4 more
   * symbols) \param [IN] fixLen       Fixed length packets [0: variable, 1:
   * fixed] \param [IN] payloadLen   Sets payload length when fixed length is
   * used \param [IN] crcOn        Enables/Disables the CRC [0: OFF, 1: ON]
   *
