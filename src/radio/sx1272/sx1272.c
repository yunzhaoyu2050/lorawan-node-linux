...
void SX1272Init( RadioEvents_t *events )
{
    ...
    TimerInit( &TxTimeoutTimer, SX1272OnTimeoutIrq, NULL );
    TimerInit( &RxTimeoutTimer, SX1272OnTimeoutIrq, NULL );
    TimerInit( &RxTimeoutSyncWord, SX1272OnTimeoutIrq, NULL );
...
void SX1272SetRx( uint32_t timeout )
{
    ...
    if( SX1272.Settings.Modem == MODEM_FSK )
    {
        ...
        {
            TimerSetValue( &RxTimeoutSyncWord, 0, SX1272.Settings.Fsk.RxSingleTimeout );
